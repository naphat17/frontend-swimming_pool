...
import { LayoutDashboard, Users, Calendar, MapPin, CreditCard, Settings, LogOut, Menu, X, Award, KeyRound } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? "block" : "hidden"}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-green-800">
          <div className="flex h-16 items-center justify-between px-4 border-b border-green-700">
            <div className="flex items-center space-x-2">
              <img src="/LOGO.png" alt="Logo" className="h-8 w-8 filter brightness-0 invert" />
              <h1 className="text-lg font-semibold text-white">ผู้ดูแลระบบ</h1>
            </div>
            <Button variant="ghost" size="sm" onClick={() => setSidebarOpen(false)} className="text-white hover:bg-green-700">
              <X className="h-5 w-5" />
            </Button>
          </div>
          ...
          <div className="border-t border-green-700 p-4">
            <div className="flex items-center">
              <div className="flex-1">
                ...
                <p className="text-xs text-green-200">ผู้ดูแลระบบ</p>
              </div>
              <Button variant="ghost" size="sm" onClick={logout} className="text-white hover:bg-green-700">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-green-800">
          <div className="flex h-16 items-center px-4 border-b border-green-700">
            <div className="flex items-center space-x-2">
              <img src="/LOGO.png" alt="Logo" className="h-8 w-8 filter brightness-0 invert" />
              <h1 className="text-lg font-semibold text-white">ผู้ดูแลระบบ</h1>
            </div>
